/* gcc -std=c99 -c -g -O0 -pedantic -Wall -Wextra -Wshadow ex4_strings_manipulations.c */
/* gcc ex4_strings_manipulations.o -o program -lm */
#include <stdio.h>
#include <string.h>
...
void reverse_first_n(char *str, size_t n)
{
	size_t i, j;
	char temp;
...
void reverse_last_n(char *str, size_t n)
{
